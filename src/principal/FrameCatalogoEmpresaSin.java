 ...
 * @author sebas
 */
public class FrameCatalogoEmpresaSin extends javax.swing.JFrame {
    ...
    try {
        ...
        if(globalcounter > 5){
            JOptionPane.showMessageDialog(null, "Ha excedido el número máximo de"
                    + " compras para una empresa sin filiales","Advertencia",2);
            System.exit(0);
        }
        else{
            //do nothing :v
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameCatalogoEmpresaSin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameCatalogoEmpresaSin("").setVisible(true);
            }
        });
    }
